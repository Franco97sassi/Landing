      ...
      <Box sx={{ background: 'white' }}>
        ...
        <Box sx={{ width: '100%', height: "100vh" }}>
          <Grid container spacing={20} sx={{ height: '100%' }}>
            <Grid item xs={12} md={6}>
              <Item>
                <Slide direction="right" triggerOnce={false} in={inView}>
                  <Box sx={{ zIndex: 0, display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', paddingLeft: "100px", height: '100%' }}>
            ...
            <Grid item xs={12} md={6}>
              <Item>
                <Box sx={{ zIndex: 1, position: 'relative', display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%' }}>
