...
const Servicios = () => {
  ...
  const style = {
   ...
   return (
    ...
    <Typography  variant={isNonMobileScreens?"h2":"h4"} style={{fontWeight: 700, fontFamily: "'Oswald', sans-serif",textAlign:"center"  }}  sx={{paddingTop:isNonMobileScreens?"0px":"50px",  color:"white", display: "flex", justifyContent: "center", paddingBottom: isNonMobileScreens?"80px":"60px"  }}>
